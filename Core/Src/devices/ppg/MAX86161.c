...
static void configurate(MAX86161Device_t* device) {
	...
	enqueueRegisterDataRequest(device,
			...
			//MAX86161_REGISTER_PPG_CONFIGURATION_1_PPG_TINT_29400_NS |
			MAX86161_REGISTER_PPG_CONFIGURATION_1_PPG_TINT_58700_NS |
			//MAX86161_REGISTER_PPG_CONFIGURATION_1_PPG_TINT_117300_NS |
	...
	enqueueRegisterDataRequest(device,
			...
			MAX86161_REGISTER_PPG_CONFIGURATION_2_SMP_AVE_1,
			0);

	enqueueRegisterDataRequest(device,
			MAX86161_REGISTER_ADDRESS_PPG_CONFIGURATION_3,
			//MAX86161_REGISTER_PPG_CONFIGURATION_3_LED_SETLNG_4_US,
			//MAX86161_REGISTER_PPG_CONFIGURATION_3_LED_SETLNG_6_US,
			//MAX86161_REGISTER_PPG_CONFIGURATION_3_LED_SETLNG_8_US,
			MAX86161_REGISTER_PPG_CONFIGURATION_3_LED_SETLNG_12_US,
			0);

	enqueueRegisterDataRequest(device,
				MAX86161_REGISTER_ADDRESS_PPG_SYNC_CONTROL,
				MAX86161_REGISTER_PPG_SYNC_CONTROL_GPIO_CTRL_EXPOSE_IN_TRIGGER,
				0);
	...
	enqueueRegisterDataRequest(device,
			...
			//MAX86161_REGISTER_PHOTO_DIODE_BIAS_PDBIAS1_65_PF,
			MAX86161_REGISTER_PHOTO_DIODE_BIAS_PDBIAS1_520_PF |
			MAX86161_REGISTER_PHOTO_DIODE_BIAS_PDBIAS1_520_PF,
			0);
