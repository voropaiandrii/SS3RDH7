...
/* USER CODE BEGIN 0 */
/*
 * hi2c1 - MAXM86161 left
 * hi2c2 - MAXM86161 right
 * hi2c4 - MAX30102
*/
/* USER CODE END 0 */
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspInit 0 */
    ...
    */
    ...
    /* I2C1 interrupt Init */
    HAL_NVIC_SetPriority(I2C1_EV_IRQn, 5, 1);
  ...
  /* USER CODE END I2C2_MspInit 0 */
    ...
    */
    ...
    /* I2C2 interrupt Init */
    HAL_NVIC_SetPriority(I2C2_EV_IRQn, 6, 10);
    HAL_NVIC_EnableIRQ(I2C2_EV_IRQn);
    HAL_NVIC_SetPriority(I2C2_ER_IRQn, 6, 10);
  ...
  /* USER CODE END I2C4_MspInit 0 */
    ...
    */
    ...
    /* I2C4 interrupt Init */
    HAL_NVIC_SetPriority(I2C4_EV_IRQn, 7, 3);
    HAL_NVIC_EnableIRQ(I2C4_EV_IRQn);
    HAL_NVIC_SetPriority(I2C4_ER_IRQn, 7, 3);
